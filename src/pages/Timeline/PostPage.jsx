...
function PostPage() {
  const [imageSentData, setImageSentData] = useState(
  ...
  const handleDislikeClick = async (e) => {
    ...
    // Verificar se o usuário já curtiu a postagem na coleção "interactions"
    const userAlreadyLiked = await checkUserDislikeInteraction(
      userId,
      postIdInt
    );
  ...
  function ProfileImage() {
    ...
    const profileImageUrl = selectedProfile
                      ...
                      <div className="tl-modo-resposta">
                        <label className="tl-modo-resposta-label">
                          <input
                            type="radio"
                            value="publico"
                            checked={modoResposta === "public"}
                            onChange={() => handleModoRespostaChange("public")}
                          />
                          Público
                        </label>
                        <label className="tl-modo-resposta-label">
                          <input
                            type="radio"
                            value="anonimo"
                            checked={modoResposta === "anon"}
                            onChange={() => handleModoRespostaChange("anon")}
                          />
                          Anônimo
                        </label>
                      </div>
                      <textarea
                        className="tl-reply-textarea"
                        placeholder="Escreva sua resposta..."
                        value={replyText}
                        onChange={(e) => setReplyText(e.target.value)}
                      ></textarea>
                      <button className="tl-reply-button" onClick={handleReply}>
                        Responder
                      </button>
                    </div>
                  )}
