      ...
      <div className="sobre">
        <header className="header-sobre" id="header">
          <div className="header-logo-sobre">
            ...
            <h1 className="logo-text-sobre">Ceferno</h1>
          </div>
          <div className="header-items-sobre">
            <div className="header-item-sobre">
              <Link style={{ textDecoration: 'none' }} to="/sobre">
                <div className="item-title-sobre">
                  <h1 className="title-text-sobre sobre">Sobre</h1>
                </div>
              </Link>
            </div>
            <div className="header-item-sobre">
              <Link style={{ textDecoration: 'none' }} to="/tutorial">
                <div className="item-title-sobre">
                  <h1 className="title-text-sobre ">Tutorial</h1>
                </div>
              </Link>
            </div>
            <div className="header-item-sobre">
              <Link style={{ textDecoration: 'none' }} to="/contato">
                <div className="item-title-sobre">
                  <h1 className="title-text-sobre">Contato</h1>
                </div>
              </Link>
            </div>
