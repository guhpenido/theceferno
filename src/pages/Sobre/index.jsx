        ...
        <>
            <header className="header" id="header">
                <div className="header-logo">
                    <svg width="479" height="485" viewBox="0 0 479 485" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="header-items">
                    ...
                    <Link to="/register"><p href="" className="header-link">Acesse TheCeferno</p></Link>
                </div>
            </header>
            <main className="main" id="main">
            <section className="home-section" id="home">
            <h1 className="home-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h1>
            <Link to="/register"><button  className="home-button">Acesse TheCeferno</button></Link>
        </section>
        </main>
        </>
    );
