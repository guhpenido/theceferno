  ...
  return (
    <>
      <div className="tutorial">
        <header className="header-tutorial" id="header">
          <div className="header-logo-tutorial">
            <svg
              width="479"
              height="485"
              viewBox="0 0 479 485"
            ...
            <h1 className="logo-text-tutorial">Ceferno</h1>
          </div>
          <div className="header-items-tutorial">
            <div className="header-item-tutorial">
            <Link style={{ textDecoration: 'none' }} to="/sobre">
              <div className="item-title-tutorial">
                <h1 className="title-text-tutorial">Sobre</h1>
              </div>
              </Link>
            </div>
            <div className="header-item-tutorial">
            <Link style={{ textDecoration: 'none' }} to="/tutorial">
              <div className="item-title-tutorial">
                <h1 className="title-text-tutorial tutorial">Tutorial</h1>
              </div>
              </Link>
            </div>
            <div className="header-item-tutorial">
            <Link style={{ textDecoration: 'none' }} to="/contato">
              <div className="item-title-tutorial">
                <h1 className="title-text-tutorial">Contato</h1>
              </div>
              </Link>
            </div>
            <Link style={{ textDecoration: 'none' }} to="/register">
              <p href="" className="header-link-tutorial">
                Acesse TheCeferno
              </p>
            </Link>
          </div>
        ...
        <main className="main" id="main">
            <div className="container1 container-fluid" data-aos="fade-up">
            <div className="section-header-tutorial my-2">
            ...
            <div className="container-fluid" data-aos="fade-up">
              <div className="section-header my-2">
                ...
                <div className="row mt-4">
                  <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 my-4">
                ...
                <div className="row">
                  <div className="col-12 col-sm-6 col-md-6 col-xl-6  my-4">
            ...
            <div className="container-fluid" data-aos="fade-up">
              <div className="section-header-tutorial my-2">
                ...
                <div className="row mt-4">
                  <div className="col-12 col-sm-6 col-md-6 col-xl-6  my-4 text-center">
