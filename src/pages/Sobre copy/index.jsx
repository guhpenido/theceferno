      ...
      <header className="header" id="header">
        ...
        <div className="header-items">
          <div className="header-item">
            <div className="item-title sobre">
            ...
            <div className="row gy-4">
              ...
              <div className="col-lg-6">
                <div className="content ps-0 ps-lg-5">
                  ...
                  by injected humour, or randomised words which don't look even slightly believable.All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, 
              ...
              <div className="row gy-4">
                <div className="row gy-5 col-lg-6">
                  <p>
                ...
                <div className="row gy-1 col-lg-6">
                  <div className="content ps-0 ps-lg-5">
                    <h3>Lorem Ipsum</h3>
                    <p>
