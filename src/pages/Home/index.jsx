      ...
      <div className="home">
            ...
            <div className="header-items-home">
              ...
              <Link style={{ textDecoration: 'none' }} to="/sobre">
                <div className="item-title-home">
                  <h1 className="title-text-home">Sobre</h1>
                </div>
                </Link>
              </div>
              ...
              <Link style={{ textDecoration: 'none' }} to="/tutorial">
                <div className="item-title-home">
                  <h1 className="title-text-home">Tutorial</h1>
                </div>
                </Link>
              </div>
              <div className="header-item-home">
              <Link style={{ textDecoration: 'none' }} to="/contato">
                <div className="item-title-home">
                  <h1 className="title-text-home">Contato</h1>
                </div>
                </Link>
              </div>
            </div>
        ...
        <main className="main-home" id="main">
          <section className="home-section" id="home">
            ...
            <h1 style={{fontSize:'100px'}} className="titulo-home">CEFERNO</h1>
