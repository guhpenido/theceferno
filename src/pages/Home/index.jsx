  ...
  const toggleCursorSize = () => {
    ...
    return (
      <>
      <div className={`content ${cursorSize ? 'large-cursor' : ''}`}>
      <button onClick={toggleCursorSize}>Toggle Cursor Size</button>
      <div className="home-super-screen">
      <div className="div-home-cefernoFullImg"><img className="home-cefernoFullImg" src={cefernoFullImg}></img></div>
        <div className="home-screen">
          ...
          <main className="main-home" id="main">
            <section className="home-section" id="home">
              <div className="div-home-cefernoTextoImg"><img className="home-cefernoTextoImg" src={cefernoTextoImg}></img></div>
              ...
              <Link className="botaoAcessar" to="/register">
                <button className="home-button home-botao-Tlgrande" id="home-botao-criar-conta-Tlgrande">Criar Conta</button>
              </Link>
