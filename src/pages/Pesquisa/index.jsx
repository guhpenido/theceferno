        ...
        <div className="tl-ladoDireito-boxProcura">
          <div className="tl-ladoDireito-proc-resultados">
            ...
            {usuarios.map((usuario) => (
              <Link to={`/VisitorPage/${usuario.id}`} className="tl-ladoDireito-proc-perfis" key={usuario.id}>
            ...
            {postsUsuario.slice(0, 3).map((post) => (
              <div className="tl-ladoDireito-proc-postsUser" key={post.postId}>
            ...
            <div className="tl-ladoDireito-proc-postMentioned" key={post.postId}>
              <div className="postMentioned-header">
                ...
                <div className="postMentioned-header2">
                  ...
                  <div className="postMentioned-header-fotoMentioned"><img src={userDataMap[post.userMentioned]?.imageUrl} alt="" /></div>
