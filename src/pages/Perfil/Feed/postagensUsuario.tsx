...
import { getFirestore, doc, getDoc, updateDoc, orderBy } from 'firebase/firestore';
...
const PostagensUsuario: React.FC = () => {
    ...
    //pegar os whispers (mensagens que aquela pessoa postou)
    useEffect(() => {
        const q = query(collection(db, 'timeline'), where('userMentioned', '==', currentUser), orderBy('time', 'desc'), where('userSent', "==", null));
