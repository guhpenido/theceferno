...
var reducer = function() {
  return function(state, action) {
    switch (action.type) {
      case "error":
        return __assign({}, state, { error: action.error, loading: false, value: void 0 });
      case "reset":
        return defaultState(action.defaultValue);
      case "value":
        return __assign({}, state, { error: void 0, loading: false, value: action.value });
      default:
        return state;
    }
  };
    ...
    return __awaiter(_this$1, void 0, void 0, function() {
      ...
      return __generator(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            _a2.trys.push([1, 5, , 6]);
            return [4, auth.createUserWithEmailAndPassword(email, password)];
          case 2:
            user = _a2.sent();
            if (!(options && options.sendEmailVerification && user.user))
              return [3, 4];
            return [4, user.user.sendEmailVerification(options.emailVerificationOptions)];
          case 3:
            _a2.sent();
            _a2.label = 4;
          case 4:
