...
var __PRIVATE_IndexedDbMutationQueue = class {
  constructor(e, t, n, r2) {
    this.userId = e, this.serializer = t, this.indexManager = n, this.referenceDelegate = r2, this.Cn = {};
  }
  static lt(e, t, n, r2) {
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this.oi = t, this.persistenceKey = n, this.Vs = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.fs = this.gs.bind(this), this.ps = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.ys = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = D2.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.Vo(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_PersistentStream = class {
  ...
  async close(e, t) {
    this.n_(), this.r_(), this.jo.cancel(), this.Wo++, 4 !== e ? this.jo.reset() : t && t.code === D2.RESOURCE_EXHAUSTED ? (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.jo.ko()) : t && t.code === D2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.i_(), this.stream.close(), this.stream = null), this.state = e, await this.listener.To(t);
  }
  i_() {
  }
  auth() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  ...
  const i = __PRIVATE_debugCast(e), { request: s, V_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    ...
    return t2.Ie || (t2.Ie = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.Ie;
  }(t), n), _ = s.parent;
  i.connection.wo || delete s.parent;
  const a = (await i.vo("RunAggregationQuery", _, s, 1)).filter((e2) => !!e2.result);
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ea = e, this.localStore = t, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
  }
  ta(e) {
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.va) {
    ...
    for (const e2 of n)
      r2.ga.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.Oa.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Oa.syncEngine), await __PRIVATE_fillWritePipeline(this.Oa.remoteStore), await this.persistence.fi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.Oa = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.La = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.ka = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Ga = n.maxAttempts, this.jo = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Ga -= 1, this.za();
  }
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(true), function __PRIVATE_remoteStoreEnableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      return t2.v_.delete(0), __PRIVATE_enableNetworkInternal(t2);
    }(n);
  });
}
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.v_.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.x_.set("Offline");
    }(n);
  });
}
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.3.0", e), registerVersion(w2, "4.3.0", "esm2017");
}();
export {
