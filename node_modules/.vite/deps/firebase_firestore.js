import {
  ...
  registerVersion
<<<<<<< HEAD
} from "./chunk-BRBTDE2R.js";
=======
} from "./chunk-4VJZG5ZW.js";
>>>>>>> prodStella
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
    this.user = e, this.databaseId = t, this.un = new __PRIVATE_MemoryCollectionParentIndex(), this.cn = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  addToCollectionParentIndex(e, t) {
    if (!this.un.has(t)) {
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  constructor(e, t) {
    super(), this.ur = e, this.trackRemovals = t, this.cr = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
  ...
  getAllFromCache(e, t) {
    return this.ur._r(e, t).next(({ documents: e2, ar: t2 }) => (t2.forEach((t3, n) => {
      this.cr.set(t3, {
        size: n,
...
var __PRIVATE_IndexedDbPersistence = class {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this._i = i, this.window = s, this.document = o, this.ai = a, this.ui = u, this.ci = c, this.qr = null, this.Qr = false, this.isPrimary = false, this.networkEnabled = true, this.li = null, this.inForeground = false, this.hi = null, this.Pi = null, this.Ii = Number.NEGATIVE_INFINITY, this.di = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.C())
  ...
  setNetworkEnabled(e) {
    this.networkEnabled !== e && (this.networkEnabled = e, this._i.enqueueAndForget(async () => {
  ...
  async shutdown() {
    this.Qr = false, this.Oi(), this.Pi && (this.Pi.cancel(), this.Pi = null), this.Ni(), this.Bi(), await this.Ei.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
  ...
  mi() {
    ...
    "function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.li = () => {
      ...
      isSafari() && (navigator.appVersion.match(e2) || navigator.userAgent.match(e2)) && this._i.enterRestrictedMode(true), this._i.enqueueAndForget(() => this.shutdown());
...
var __PRIVATE_QueryEngine = class {
  constructor() {
    this.Ui = false, this.Wi = false, this.Gi = 100, this.zi = 8;
  }
  initialize(e, t) {
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this._i = t, this.persistenceKey = n, this.fs = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.gs = this.ps.bind(this), this.ys = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.ws = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Ss = createWebStorageClientStateKey(this.persistenceKey, this.fs), this.bs = function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.ys = this.ys.insert(this.fs, new __PRIVATE_LocalClientState()), this.Ds = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.Cs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.vs = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.Fs = function createWebStorageOnlineStateKey(e2) {
    ...
    }(this.persistenceKey), this.window.addEventListener("storage", this.gs);
  }
  static C(e) {
  ...
  async start() {
    ...
    for (const e2 of this.ws)
      this.ps(e2);
    this.ws = [], this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = D2.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.mo(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_PersistentStream = class {
  ...
  async close(e, t) {
    this.r_(), this.i_(), this.Ho.cancel(), this.Go++, 4 !== e ? this.Ho.reset() : t && t.code === D2.RESOURCE_EXHAUSTED ? (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.Ho.qo()) : t && t.code === D2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.s_(), this.stream.close(), this.stream = null), this.state = e, await this.listener.Eo(t);
  }
  s_() {
  }
  auth() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  ...
  const i = __PRIVATE_debugCast(e), { request: s, m_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    ...
    return t2.de || (t2.de = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.de;
  }(t), n), _ = s.parent;
  i.connection.So || delete s.parent;
  const a = (await i.Fo("RunAggregationQuery", _, s, 1)).filter((e2) => !!e2.result);
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ta = e, this.localStore = t, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
  }
  na(e) {
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.Fa) {
    ...
    for (const e2 of n)
      r2.pa.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.Na = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    }, await this.sharedClientState.start()), await this.persistence.gi(async (e2) => {
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(true), function __PRIVATE_remoteStoreEnableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      return t2.F_.delete(0), __PRIVATE_enableNetworkInternal(t2);
    }(n);
  });
}
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.F_.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.O_.set("Offline");
    }(n);
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).K_.add(t2), t2.next();
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.2.0", e), registerVersion(w2, "4.2.0", "esm2017");
}();
export {
